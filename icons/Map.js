        ...
        if (!focused) {
            return (
                <Svg width={width} height={height} viewBox={viewBox}>
                    <Path
                        d='M21.389 0l-.196.037-6.526 2.53L7.333 0 .44 2.322A.616.616 0 000 2.91v18.48c0 .342.269.611.611.611l.196-.037 6.526-2.53L14.667 22l6.893-2.322a.616.616 0 00.44-.587V.611A.605.605 0 0021.389 0zM8 2.444l5.889 2.267v14.845L8 17.25V2.444zM2 4.313L6 3v15.21l-4 1.508V4.313zm17.667 14.08L16 19.706V4.508L19.667 3v15.393z'
                        fill={fill}
                        fillRule='nonzero'
                    />
                </Svg>
